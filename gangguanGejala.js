...
function diagnosa() {
  ...
  if (hasilDiagnosa.length > 0) {
    hasilText.innerHTML =
      "Berdasarkan gejala yang Anda alami, kemungkinan penyakit yang Anda derita adalah: <u>" +
      hasilDiagnosa.join("<span class='highlighted'> | </span>") +
      "</u>";
  }
   else {
...
function toggleDivCheckbox(div) {
